...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>" alt=""></a></div>
      <div class="tittle">
      <h1 style="color:red;text-align:center; font-weight:bold;font:italic; font-size :65px;">ARON's HOTEL</h1>
      ...
      <nav class="main_nav">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=gallery1">Gallery</a></li>
        </ul>
      </nav>
      ...
      <div class="social header_social">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="#"><i class="fa fa-linkdin" aria-hidden="true"></i></a></li>
        </ul>
      </div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="home_text text-center"><h3>Welcome to ARON's Hotel</h3></div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>Ring Road, South Delhi, <br> India 110066</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></a>
